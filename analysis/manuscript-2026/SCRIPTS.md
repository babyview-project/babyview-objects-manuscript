...
| [`scripts/export_codeocean_capsule.sh`](scripts/export_codeocean_capsule.sh) | publish | Slim CodeOcean / public repo | See [`CODEOCEAN_EXPORT.md`](CODEOCEAN_EXPORT.md) |
