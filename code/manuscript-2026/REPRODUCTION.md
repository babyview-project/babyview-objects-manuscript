...
See [`DATA_AVAILABILITY.md`](DATA_AVAILABILITY.md) (includes GitHub link,
provisional Code Ocean DOI https://doi.org/10.24433/CO.0860553.v1 — under
review, licenses, and suggested manuscript availability text).
